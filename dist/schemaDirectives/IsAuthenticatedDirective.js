...
var IsAuthenticatedDirective = (function (_super) {
    ...
    IsAuthenticatedDirective.getDirectiveDeclaration = function (directiveName, schema) {
        return new graphql_1.GraphQLDirective({
            name: "isAuthenticated",
            locations: [graphql_1.DirectiveLocation.FIELD_DEFINITION, graphql_1.DirectiveLocation.OBJECT]
        });
    };
    IsAuthenticatedDirective.prototype.visitObject = function (obj) {
